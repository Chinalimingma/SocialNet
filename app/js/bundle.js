...
},{"./apps/contacts/router":12,"./apps/login/router":40,"./common":43,"backbone":46,"backbone-validation":45,"jquery":47,"noty":48,"sweetalert":57,"underscore":58}],2:[function(require,module,exports){
'use strict';
...
},{"../../app":1,"./collections/contactCollection":3,"./controllers/contactEditor":6,"./controllers/contactList":7,"./controllers/contactViewer":8,"./models/contact":9}],3:[function(require,module,exports){
'use strict';
...
},{"../models/contact":9,"backbone":46}],4:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../models/email":10,"backbone":46}],5:[function(require,module,exports){
'use strict';
var App = require('../../../app');
var Backbone = require('backbone');
...
},{"../../../app":1,"../models/phone":11,"backbone":46}],6:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../collections/emailCollection":4,"../collections/phoneCollection":5,"../views/contactEditorEmailListView":25,"../views/contactEditorForm":26,"../views/contactEditorFormLayout":27,"../views/contactEditorPhoneListView":28,"../views/contactEditorPreview":29,"backbone":46,"underscore":58}],7:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../views/contactListActionBar":30,"../views/contactListLayout":32,"../views/contactListView":33,"backbone":46,"underscore":58}],8:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../views/contactViewerAbout":34,"../views/contactViewerCallLog":35,"../views/contactViewerLayout":36,"../views/contactViewerWidget":37,"backbone":46,"underscore":58}],9:[function(require,module,exports){
'use strict';
...
},{"backbone":46,"backbone-validation":45,"jquery":47,"underscore":58}],10:[function(require,module,exports){
'use strict';
var Backbone = require('backbone');
...
},{"backbone":46}],11:[function(require,module,exports){
'use strict';
...
},{"backbone":46}],12:[function(require,module,exports){
'use strict';
...
},{"../../app":1,"./app":2,"backbone":46}],13:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="panel panel-info"> <div class="panel-heading"><h3 class="panel-title">General info</h3></div> <div class="panel-body"> <form class="form-horizontal"> <div class="form-group"> <label for="name" class="col-sm-2 control-label">Name</label> <div class="col-sm-10"> <input id="name" type="text" class="form-control" placeholder="Full name" value="'+
((__t=( name ))==null?'':__t)+
'"> </div> </div> <div class="form-group"> <label for="address" class="col-sm-2 control-label">Address</label> <div class="col-sm-10"> <input id="address" type="text" class="form-control" placeholder="Street, number, interior, suite" value="'+
((__t=( address1 ))==null?'':__t)+
'"> </div> </div> </form> </div> </div> <div class="panel panel-info"> <div class="panel-heading"> Phones <button id="new-phone" class="btn btn-primary btn-sm pull-right">New</button> </div> <div class="panel-body"> <form class="form-horizontal phone-list-container"></form> </div> </div> <div class="panel panel-info"> <div class="panel-heading"> Emails <button id="new-email" class="btn btn-primary btn-sm pull-right">New</button> </div> <div class="panel-body"> <form class="form-horizontal email-list-container"></form> </div> </div> <div class="panel panel-info"> <div class="panel-heading">Social</div> <div class="panel-body"> <form class="form-horizontal"> <div class="form-group"> <label for="facebook" class="col-sm-2 control-label">Facebook</label> <div class="col-sm-10"> <input id="facebook" type="text" class="form-control" placeholder="https://www.facebook.com/abiee.alejandro" value="'+
((__t=( facebook ))==null?'':__t)+
'"> </div> </div> <div class="form-group"> <label for="twitter" class="col-sm-2 control-label">Twitter</label> <div class="col-sm-10"> <input id="twitter" type="text" class="form-control" placeholder="https://twitter.com/abieealejandro" value="'+
((__t=( twitter ))==null?'':__t)+
'"> </div> </div> <div class="form-group"> <label for="google" class="col-sm-2 control-label">Google+</label> <div class="col-sm-10"> <input id="google" type="text" class="form-control" placeholder="https://plus.google.com/u/0/+AbieeAlejandroEchameaMárquez" value="'+
((__t=( google ))==null?'':__t)+
'"> </div> </div> <div class="form-group"> <label for="github" class="col-sm-2 control-label">Github</label> <div class="col-sm-10"> <input id="github" type="text" class="form-control" placeholder="https://github.com/abiee" value="'+
((__t=( github ))==null?'':__t)+
'"> </div> </div> </form> </div> <div class="panel-footer clearfix"> <div class="panel-buttons"> <button id="cancel" class="btn btn-warning">Cancel</button> <button id="save" class="btn btn-success">Save</button> </div> </div> </div>';
}
return __p;
};

},{"underscore":58}],14:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div id="preview-container" class="col-xs-12 col-sm-4 col-md-3"></div> <div id="form-container" class="col-xs-12 col-sm-8 col-md-9"></div> <div class="footer text-muted"> © 2017. <a href="#">Mastering Backbone.js</a> by <a href="" target="_blank">Eric</a> </div>';
}
return __p;
};
...
__p+=' <img src="'+
((__t=( avatar.url ))==null?'':__t)+
'" alt="'+
((__t=( avatar.file ))==null?'':__t)+
'"> ';
 } else { 
__p+=' <img src="../../../../img/250_250.png" alt="Contact photo"> ';
 } 
__p+=' <input id="avatar" name="avatar" type="file" style="display: none"> <span class="info"></span> <span class="notice"></span> <div class="alert alert-success" role="alert"> Click the image to change the avatar<br> Press the shift key to upload multiple files at the same time </div> <div id="progressbar"></div> </div> <div class="caption"> <h5> <strong>'+
((__t=( name ))==null?'':__t)+
'</strong> </h5> <p class="phone no-margin"> '+
((__t=( phone ))==null?'':__t)+
' </p> <p class="email no-margin"> '+
((__t=( email ))==null?'':__t)+
' </p> <ul class="social-networks"> ';
 if (facebook) { 
__p+=' <li> <a href="'+
((__t=( facebook ))==null?'':__t)+
'" title="Google Drive"> <i class="fa fa-facebook"></i> </a> </li> ';
 } 
__p+=' ';
 if (twitter) { 
__p+=' <li> <a href="'+
...
__p+=' <li> <a href="'+
((__t=( google ))==null?'':__t)+
'" title="Google Drive"> <i class="fa fa-google-plus"></i> </a> </li> ';
 } 
__p+=' ';
 if (github) { 
__p+=' <li> <a href="'+
...
},{"underscore":58}],16:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<button type="button" class="btn btn-lg btn-success pull-right">Create a new contact</button>';
}
return __p;
};

},{"underscore":58}],17:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="box thumbnail"> <div class="photo"> ';
 if (avatar && avatar.url) { 
__p+=' <img src="'+
((__t=( avatar.url ))==null?'':__t)+
...
__p+=' <img src="..\\..\\..\\..\\img\\250_250.png" class="img-responsive" alt="Contact photo"> ';
 } 
__p+=' <div class="action-bar clearfix"> <div class="action-buttons pull-right"> <button id="delete" class="btn btn-danger btn-xs">delete</button> <button id="view" class="btn btn-primary btn-xs">detail</button> </div> </div> </div> <div class="caption caption-container"> <h4> <strong class="text-info">'+
((__t=( name ))==null?'':__t)+
'</strong> </h4> ';
 if (phone) { 
__p+=' <p class="phone no-margin"> '+
((__t=( phone ))==null?'':__t)+
' </p> ';
 } 
__p+=' ';
 if (email) { 
__p+=' <p class="email no-margin"> '+
((__t=( email ))==null?'':__t)+
' </p> ';
 } 
__p+=' <p class="bottom"> <ul class="social-networks"> ';
 if (facebook) { 
__p+=' <li> <a href="'+
((__t=( facebook ))==null?'':__t)+
'" title="Google Drive"> <i class="fa fa-facebook"></i> </a> </li> ';
...
},{"underscore":58}],18:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="actionBar-container"></div> <div class="list-container"></div> <div class="footer text-muted"> © 2017. <a href="#">Mastering Backbone.js</a> by <a href="" target="_blank">Eric</a> </div>';
}
return __p;
};

},{"underscore":58}],19:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="panel-heading">About '+
((__t=( name ))==null?'':__t)+
'</div> <div class="pabel-body"> <div class="contact-info"> <div class="bio"> <span class="text-info h4">Biography</span> <p> <mark>Bio:</mark> '+
((__t=( bio ))==null?'':__t)+
' </p> </div> <span class="text-info h4">Basic information</span> <div class="table-responsive"> <table class="table"> <tbody> <tr> <th>Email</th> <td><a href="mailto:'+
((__t=( email ))==null?'':__t)+
'">'+
((__t=( email ))==null?'':__t)+
'</a></td> </tr> <tr> <th>Phone</th> <td>'+
((__t=( phone ))==null?'':__t)+
'</td> </tr> <tr> <th>Social</th> <td> <ul class="list-inline"> ';
 if (facebook) { 
__p+=' <li> <a href="'+
((__t=( facebook ))==null?'':__t)+
'" title="Google Drive"> <i class="fa fa-facebook"></i> </a> </li> ';
...
__p+=' </ul> </td> </tr> </tbody> </table> </div> <span class="text-info h4">Personal information</span> <div class="table-responsive"> <table class="table"> <tbody> <tr> <th>Name</th> <td>'+
((__t=( name ))==null?'':__t)+
'</td> </tr> <tr> <th>Address</th> <td>'+
((__t=( address1 ))==null?'':__t)+
'</td> </tr> </tbody> </table> </div> </div> </div> <div class="panel-footer clearfix"> <div class="panel-buttons"> <button id="back" class="btn btn-primary">Go back</button> <button id="delete" class="btn btn-danger">Delete</button> <button id="edit" class="btn btn-success">Edit contact</button> </div> </div>';
}
return __p;
};

},{"underscore":58}],20:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="panel-heading"><strong class="text-info">Call log</strong></div> <div class="pabel-body"> <div class="call-log"> <table class="table table-hover"> <thead> <tr> <th class="text-info">Type</th> <th class="text-info">Date</th> <th class="text-info">Elapsed time</th> </tr> </thead> <tbody> <tr> <td>Income</td> <td>2 days ago</td> <td>3 minutes</td> </tr> <tr> <td>Income</td> <td>3 days ago</td> <td>17 minutes</td> </tr> <tr> <td>Outcome</td> <td>5 days ago</td> <td>1 minute</td> </tr> </tbody> </table> </div> </div>';
}
return __p;
};

},{"underscore":58}],21:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row page-container"> <div id="contact-widget" class="col-xs-12 col-sm-4 col-md-3"></div> <div class="col-xs-12 col-sm-8 col-md-9"> <div class="row"> <div id="about-container"></div> <div id="call-log-container"></div> </div> </div> </div> <div class="footer text-muted"> © 2015. <a href="#">Mastering Backbone.js</a> by <a href="https://twitter.com/abieealejandro" target="_blank">Eric</a> </div>';
}
return __p;
};

},{"underscore":58}],22:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<h3 class="text-info">'+
((__t=( name ))==null?'':__t)+
'</h3> ';
 if (avatar && avatar.url) { 
__p+=' <img src="'+
((__t=( avatar.url ))==null?'':__t)+
'" alt="Contact photo" class="img-circle"> ';
 } else { 
__p+=' <img src="http://placehold.it/250x250" alt="Contact photo" class="img-circle"> ';
 } 
__p+=' <ul class="social-networks"> ';
 if (facebook) { 
__p+=' <li> <a href="'+
((__t=( facebook ))==null?'':__t)+
'" title="Google Drive"> <i class="fa fa-facebook"></i> </a> </li> ';
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="col-sm-4 col-md-2"> <input type="text" class="form-control description" placeholder="home, office, mobile" value="'+
((__t=( description ))==null?'':__t)+
'"> </div> <div class="col-sm-6 col-md-8"> <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span> <input type="text" class="form-control email" placeholder="john.doe@example.com" value="'+
((__t=( email ))==null?'':__t)+
'"> </div> </div> <div class="col-sm-2 col-md-2 action-links"> <a href="#" class="pull-rigth delete btn btn-default">delete</a> </div>';
}
return __p;
};

},{"underscore":58}],24:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="col-sm-4 col-md-2"> <input type="text" class="form-control description" placeholder="home, office, mobile" value="'+
((__t=( description ))==null?'':__t)+
'"> </div> <div class="col-sm-6 col-md-8"> <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span> <input type="text" class="form-control phone" placeholder="(123) 456 7890" value="'+
((__t=( phone ))==null?'':__t)+
'"> </div> </div> <div class="col-sm-2 col-md-2 action-links"> <a href="#" class="pull-rigth delete btn btn-default">delete</a> </div>';
}
return __p;
...
},{"underscore":58}],25:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"./emailListItemView":38}],26:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactEditorForm.tpl":13,"backbone-validation":45,"underscore":58}],27:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactEditorFormLayout.tpl":14}],28:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"./phoneListItemView":39}],29:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactEditorPreview.tpl":15}],30:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../../../common":43,"../templates/contactListActionBar.tpl":16}],31:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../../../common":43,"../templates/contactListItem.tpl":17}],32:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactListLayout.tpl":18}],33:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"./contactListItemView":31}],34:[function(require,module,exports){
'use strict';
...
},{"../../../app":1,"../../../common":43,"../templates/contactViewAbout.tpl":19}],35:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactViewCallLog.tpl":20}],36:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactViewLayout.tpl":21}],37:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/contactViewWidget.tpl":22}],38:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/emailListItemView.tpl":23}],39:[function(require,module,exports){
'use strict';
...
},{"../../../common":43,"../templates/phoneListItemView.tpl":24}],40:[function(require,module,exports){
...
},{"../../../app":1,"../../../common":43,"../templates/loginView.tpl":41,"backbone":46}],43:[function(require,module,exports){
/*
Marionette includes all the views exposed here: ItemView, CollectionView,
LayoutView, Regions. and other useful view types. Marionette objects behave very
similarly to what we see here
...
class ModelView extends Backbone.View {
    render() {
        ...
        // If template is a function assume that is a compiled template, if not assume that is 
        //a CSS selector where the template is defined and is compatible with underscore templates
        ...
        /*
        Plugins should be called only after the view is on the DOM, because most plugins
        are DOM-dependent. When rendering plugins, remember to do it in the view not
        outside it; the onShow() callback strategy ensures that the view is available on the
...
/**
 * View with collection – Render a collection of views with collection data;
...
class CollectionView extends Backbone.View {
    ...
    //Callback when the modelView is in the DOM
    onShow() {
        var children = this.children || {};
        _.each(children, child => {
            if (child.onShow) {
...
/**
 * Region – This view acts like a container; it points to a particular DOM node
   and manages the content for that node. It's used to render other views.
 */
class Region {
    constructor(options) {
        this.el = options.el;
    ...
    // Closes any active view and render a new enter one--singleton
    show(view) {
    ...
    closeView(view) {
        // Only remove the view when the remove function is available
        //There is remove method in the view class prototype
        if (view && view.remove) {
            view.remove();
        }
    }
    ...
    openView(view) {
        ...
        view.render();//render the view in memory
    ...
    // Close the Region and any view on it, make regions compatible with 
    //remove method of Backbone Views.
    remove() {
        this.closeView(this.currentView);
    }
}
...
/**
 * Layout – A layout is composed of one or more regions; it defines an HTML structure
   to organize where the regions will be placed. A common web application layout is
   composed of a header, a sidebar, footer, and a common area.
 */
...
},{"backbone":46,"jquery":47,"underscore":58}],44:[function(require,module,exports){
var App = require('./app');

App.start();
},{"./app":1}],45:[function(require,module,exports){
...
},{"backbone":46,"underscore":58}],46:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"jquery":47,"underscore":58}],47:[function(require,module,exports){
/*!
...
module.exports = exports['default'];
},{"./handle-dom":51,"./handle-swal-dom":53,"./utils":56}],51:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./handle-dom":51,"./handle-swal-dom":53}],53:[function(require,module,exports){
'use strict';
...
},{"./default-params":49,"./handle-dom":51,"./injected-html":54,"./utils":56}],54:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./handle-dom":51,"./handle-swal-dom":53,"./utils":56}],56:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./modules/default-params":49,"./modules/handle-click":50,"./modules/handle-dom":51,"./modules/handle-key":52,"./modules/handle-swal-dom":53,"./modules/set-params":55,"./modules/utils":56}],58:[function(require,module,exports){
//     Underscore.js 1.8.3
